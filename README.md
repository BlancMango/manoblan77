# manoblan77
manoblan77 is a collection of utilities for interacting with Web3 and Ethereum smart contracts.
...
```bash
npm install manoblan77
```
## Usage

const Web3Tools = require('manoblan77');
